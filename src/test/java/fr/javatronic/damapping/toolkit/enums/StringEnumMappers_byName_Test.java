...
/**
 * StringEnumMappers_byName_Test - Unit tests for class mapping an enum to and from a String by the enum name method.
 *
 * @author Sébastien Lesaint
 */
public class StringEnumMappers_byName_Test {
